...
public final class TwoDeadWheelLocalizer implements Localizer {
    ...
    public static class Params {
        public double parYTicks = -4154.029577844535; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 2026.7099788967664; // x position of the perpendicular encoder (in tick units)
    }
